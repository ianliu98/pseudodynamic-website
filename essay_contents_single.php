			...
			<div class="post-wrapper">
				<section class="body">
					...
					<?php
						...
						$article_cont = file_get_contents($article_abs_path.$basename.".html");
					...
					?>
					<h1 class="title">
					<a href="<?php echo $article_rel_path.$basename?>"><?php echo $article_title?></a>
					</h1>

					<h2 class="date-author">
					<time datetime="2021-06-23"><?php echo $essay_date ?></time>
					</h2>
